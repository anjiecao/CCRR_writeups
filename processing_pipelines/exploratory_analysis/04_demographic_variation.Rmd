...
- numeric: 
resimobinum - response too noisy
overseaexpnum
...
saveRDS(demog_d12_numeric_mod, here("cached_results/ea/d12_numeric_demog_df.RDS"))
...
saveRDS(demog_d12_cat_mod, here("cached_results/ea/d12_cat_demog_df.RDS"))
