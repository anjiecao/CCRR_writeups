...
\begin{table}
    \small
    \caption{Tasks included in each experiment along with the post-exclusion sample sizes.}\label{ta:upper_bound}
    \centering

    \begin{tabular}{l p{2in} p{2in} p{2in} p{.7in} p{.7in}} 
        \hline
...
<!-- kable(collapse_rows_dt, "latex", align = "l", longtable  = TRUE, -->
<!--       row.names = FALSE, -->
