...
```{r}
d1_all <-
  ((d1_up_plot / d1_fd_plot / d1_hz_plot) | (d1_rmts_plot / d1_rv_plot / d1_ssi_plot)) /  (d1_ca_plot / d1_ebb_plot) 
```
...
```{r}
d2_all <-
  ((d2_fd_plot / d2_rmts_plot / d2_rv_plot) | (d2_sei_plot / d2_ssi_plot / d2_td_plot)) /  (d2_ca_plot / d2_cd_plot) 
...
```{r}
plot_grid(d1_all, d2_all, labels = c("Exp.1", "Exp.2"))
```
