...
Higher residential mobility has been found to be related to individual's stronger emphasis on the independent self over the inter-dependent self (Ishii, Komiya, \& Oishi, 2020; Oishi \& Tsang, 2022). In our exploratory analysis's uncorrected models, we found residential mobility is a significant predictor to three task responses.
...
\hypertarget{mac-arthur-ladder}{%
\subsubsection{Mac-Arthur Ladder}\label{mac-arthur-ladder}}
...
Experiment 2 & CN & Change Detection & -735.86 & 221.15 & -3.33 & 0.00\\
...
\hypertarget{subjective-socio-economic-status}{%
\subsection{Subjective Socio-economic Status}\label{subjective-socio-economic-status}}
