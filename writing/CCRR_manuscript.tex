...
\caption{\label{fig:unnamed-chunk-19}Results from each task. Results from the CN sample are plotted in red, and results from the US sample in blue. Panels A and B include results from Experiments 1 and 2, respectively. Results for other measures used in the Free Description and Horizon Collage are plotted in Appendix B.}
\end{figure}
...
Last but not least, another difference between our experiments and previous work was the lack of an experimenter, and some of our tasks may have been particularly sensitive to the presence of an experimenter. In a web experiment, participants are often isolated in front of their own computer. In contrast, in an in-person experiment, participants must interact with and perform the task in front of experimenters who are often from the same social group. Indeed, as we discuss below, in the Uniqueness Preference pen choice task, cross-cultural differences are dependent on the presence of an experimenter (Yamagishi et al., 2008).
...
\begin{landscape}
    ...
    \caption{Differences between our tasks and the original refernce tasks, with speculation about how these differences may have impacted our results.}\\
        \hline
...
Horizon Collage  & 
    ...
    \begin{itemize}
        ...
        \item The saliency of horizon height is diminished by the drag-and-drop online interfaces.
    \end{itemize}
    \\
...
Symbolic Self-Inflation (Family version and Friends version) & 
    ...
    \end{itemize} & 
    \begin{itemize}
        \item The online interfaces might have altered participants’ drawing process, making it more difficult to implicitly represent the symbolic meaning of the circle size.
    \end{itemize}
     \\
...
\leavevmode\vadjust pre{\hypertarget{ref-strizhakova2013green}{}}%
Strizhakova, Y., \& Coulter, R. A. (2013). The {``green''} side of materialism in emerging BRIC and developed markets: The moderating role of global cultural identity. \emph{International Journal of Research in Marketing}, \emph{30}(1), 69--82.
...
In Horizon Collage task, we included two other measures in addition to the height of horizon: the number of stickers and the total area that the stickers covered. Here we show a visualization of the latter two measures. Unlike Senzaki et al. (2014), we did not see any cultural difference in either measure. We report the descriptive and inferential statistics in the main text.
