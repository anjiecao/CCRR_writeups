...
```{r fig.cap = "Results from each task. Results from the CN sample are plotted in red, and the US in blue. Panel A and B includes results from experiment 1 and 2 respectively. ",fig.width=8, fig.height=11}
plot_megaplogt()
```
