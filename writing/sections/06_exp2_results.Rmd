...
As an exploratory analysis, we also retroactively analyzed the coded accuracy of the participants' responses. Interestingly, we found main effects of culture and the type of change, as well as an interaction between culture and the type of change. Participants across both countries were more accurate in identifying changes of the focal objects than the context objects, and Chinese participants were more accurate in identifying the changes than the U.S. participants on average (US focal: *M* = `r  filter(cd_acc_summary, culture == "US", change_type == "focal")$m`, *SD* = `r filter(cd_acc_summary, culture == "US", change_type == "focal")$sd`; US context: *M* = `r  filter(cd_acc_summary, culture == "US", change_type == "context")$m`, *SD* = `r filter(cd_acc_summary, culture == "US", change_type == "context")$sd`; CN focal: *M* = `r  filter(cd_acc_summary, culture == "CN", change_type == "focal")$m`, *SD* = `r filter(cd_acc_summary, culture == "CN", change_type == "focal")$sd`; CN context: *M* = `r  filter(cd_acc_summary, culture == "CN", change_type == "context")$m`, *SD* = `r  filter(cd_acc_summary, culture == "CN", change_type == "context")$sd`). However, the difference between Chinese participants and U.S. participants was larger in focal changes than in background changes, with Chinese participants being more accurate than U.S. participants in the focal changes than in the context changes ($\beta$ = `r filter(cd_acc_model_df, predictor == "change_typefocal:cultureUS")$estimate_print`, *SE* = `r filter(cd_acc_model_df, predictor == "change_typefocal:cultureUS")$se_print`, *z* = `r filter(cd_acc_model_df, predictor == "change_typefocal:cultureUS")$z_print`, *p* `r filter(cd_acc_model_df, predictor == "change_typefocal:cultureUS")$p_print`). This interaction is different from our predictions: If we extrapolate from the original study, we should expect to see a difference in the background context, with  participants performing similarly in the background changes but Chinese participants being more accurate in the background changes than U.S. participants. 
