...
We used a mixed-effects logistic regression model predicting response (taxonomic or thematic match) with country (US or China) as a fixed effect. There was a significant effect in the predicted direction: participants in the U.S. were more likely to choose taxonomic matches than participants in China (Proportion of taxonomic matches: US: *M* = `r filter(td_summary, culture == "US")$culture_mean`; *SD* = `r filter(td_summary, culture == "US")$culture_sd`; CN: *M* = `r filter(td_summary, culture == "CN")$culture_mean`; *SD* = `r filter(td_summary, culture == "CN")$culture_sd`; $\beta$  = `r filter(td_tidy_model, predictor == "cultureUS")$estimate_print`, *SE* = `r filter(td_tidy_model, predictor == "cultureUS")$se_print`, *t* = `r filter(td_tidy_model, predictor == "cultureUS")$z_print`, *p* `r filter(td_tidy_model, predictor == "cultureUS")$p_print`). This finding replicates the findings of @ji2004culture and @le2021. 
...
We ran a mixed-effects logistic regression predicting response (descriptive or causal-historical) with country (US or China) as a fixed effect, and found that U.S. participants made significantly more causal-historical choices than Chinese participants (Proportion of causal historical choice: US: *M* = `r filter(sei_summary, culture == "US")$culture_mean`; *SD* = `r filter(sei_summary, culture == "US")$culture_sd`; CN: *M* = `r filter(sei_summary, culture == "CN")$culture_mean`; *SD* = `r filter(sei_summary, culture == "CN")$culture_sd`; $\beta$  = `r filter(sei_model, predictor == "cultureUS")$estimate_print`, *SE* = `r filter(sei_model, predictor == "cultureUS")$se_print`, *t* = `r filter(sei_model, predictor == "cultureUS")$z_print`, *p* `r filter(sei_model, predictor == "cultureUS")$p_print`). We also replicated the item effect identified by @li2018name, though this was not among our preregistered analyses. In sum, We replicated @li2018name with a new sample of US and China adults. 
